...
namespace Pacman
{
    class Clyde : Ghost
    {
            ...
            : base(texture, textureRectangles)
        {
            ...
            {
                new AnimationSequence(name: "Still", start: 24, count: 1, time: 0),
                new AnimationSequence(name: "MoveUp", start: 24, count: 2, time: 200),
                new AnimationSequence(name: "MoveDown", start: 26, count: 2, time: 200),
                new AnimationSequence(name: "MoveLeft", start: 28, count: 2, time: 200),
                new AnimationSequence(name: "MoveRight", start: 30, count: 2, time: 200),
