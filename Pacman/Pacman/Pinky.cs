...
namespace Pacman
{
    class Pinky : Ghost
    {
            ...
            : base(texture, textureRectangles)
        {
            ...
            {
                new AnimationSequence(name: "Still", start: 8, count: 1, time: 0),
                new AnimationSequence(name: "MoveUp", start: 8, count: 2, time: 200),
                new AnimationSequence(name: "MoveDown", start: 10, count: 2, time: 200),
                new AnimationSequence(name: "MoveLeft", start: 12, count: 2, time: 200),
                new AnimationSequence(name: "MoveRight", start: 14, count: 2, time: 200),
